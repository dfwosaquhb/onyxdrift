...
_FIELD = '([\\w]+(?:_[\\w]+)*)'
_PATTERNS: list[tuple[str, str]] = [(_FIELD + '\\s+is\\s+NOT\\s+(?!equal)(?!one\\s+of)[\'\\"]([^\'\\"]+)[\'\\"]', 'not_equals'), (_FIELD + '\\s+is\\s+NOT\\s+(?!equal)(?!one\\s+of)([^\\s,\'\\"\\n]+)', 'not_equals'), (_FIELD + '(?:\\s+that)?\\s+does\\s+NOT\\s+CONTAIN\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'not_contains'), (_FIELD + '(?:\\s+that)?\\s+does\\s+NOT\\s+CONTAIN\\s+([^\\s,\'\\"\\n]+)', 'not_contains'), (_FIELD + '\\s+not\\s+contains?\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'not_contains'), (_FIELD + '\\s+not\\s+contains?\\s+([^\\s,\'\\"\\n]+)', 'not_contains'), (_FIELD + '\\s+(?:is\\s+)?(?:does\\s+)?not\\s+equals?\\s+(?:to\\s+)?[\'\\"]([^\'\\"]+)[\'\\"]', 'not_equals'), (_FIELD + '\\s+(?:is\\s+)?(?:does\\s+)?not\\s+equals?\\s+(?:to\\s+)?([^\\s,\'\\"\\n]+)', 'not_equals'), (_FIELD + '(?:\\s+that)?\\s+CONTAINS\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'contains'), (_FIELD + '\\s+contains?\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'contains'), (_FIELD + '\\s+contains?\\s+([^\\s,\'\\"\\n]+)', 'contains'), (_FIELD + '\\s+(?:is\\s+)?ON\\s+OR\\s+AFTER\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'greater_equal'), (_FIELD + '\\s+(?:is\\s+)?ON\\s+OR\\s+AFTER\\s+([^\\s,\'\\"\\n\\]]+)', 'greater_equal'), (_FIELD + '\\s+(?:is\\s+)?ON\\s+OR\\s+BEFORE\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'less_equal'), (_FIELD + '\\s+(?:is\\s+)?ON\\s+OR\\s+BEFORE\\s+([^\\s,\'\\"\\n\\]]+)', 'less_equal'), (_FIELD + '\\s+(?:is\\s+)?(?:greater\\s+(?:than\\s+)?or\\s+equal\\s+to|greater\\s+equal(?:\\s+to)?|GREATER\\s+EQUAL(?:\\s+TO)?|>=)\\s+[\'\\"]?([^\\s,\'\\"\\n\\]]+)[\'\\"]?', 'greater_equal'), (_FIELD + '\\s+(?:is\\s+)?(?:less\\s+(?:than\\s+)?or\\s+equal\\s+to|less\\s+equal(?:\\s+to)?|LESS\\s+EQUAL(?:\\s+TO)?|<=)\\s+[\'\\"]?([^\\s,\'\\"\\n\\]]+)[\'\\"]?', 'less_equal'), (_FIELD + '\\s+equals?\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'equals'), (_FIELD + '\\s+EQUALS\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'equals'), (_FIELD + '\\s+equals?\\s+([^\\s,\'\\"\\n\\]]+)', 'equals'), (_FIELD + '\\s+(?:is\\s+)?AFTER\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'greater_than'), (_FIELD + '\\s+(?:is\\s+)?AFTER\\s+([^\\s,\'\\"\\n\\]]+)', 'greater_than'), (_FIELD + '\\s+(?:is\\s+)?BEFORE\\s+[\'\\"]([^\'\\"]+)[\'\\"]', 'less_than'), (_FIELD + '\\s+(?:is\\s+)?BEFORE\\s+([^\\s,\'\\"\\n\\]]+)', 'less_than'), (_FIELD + '\\s+(?:is\\s+)?greater\\s+than\\s+[\'\\"]?([^\\s,\'\\"\\n\\]]+)[\'\\"]?', 'greater_than'), (_FIELD + '\\s+(?:is\\s+)?less\\s+than\\s+[\'\\"]?([^\\s,\'\\"\\n\\]]+)[\'\\"]?', 'less_than'), (_FIELD + '\\s+BELOW\\s+[\'\\"]?([^\\s,\'\\"\\n\\]]+)[\'\\"]?', 'less_than'), (_FIELD + '\\s+ABOVE\\s+[\'\\"]?([^\\s,\'\\"\\n\\]]+)[\'\\"]?', 'greater_than')]
